...
resp <-
    read_csv("gates2023/activities.csv") %>%
    janitor::clean_names() %>%
...
ggsave("gates2023/vote_analysis.png",
    width = 12, height = 6,
...
ggsave("gates2023/vote_analysis-binom.png",
    width = 12, height = 6,
...
ggsave("gates2023/vote_analysis-binomexact.png",
    width = 12, height = 6,
...
words <-
    read_csv("gates2023/question2.csv") %>%
    select(Answer) %>%
